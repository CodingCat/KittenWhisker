...
3. Eventually, the generated files are uploaded to the shared storage system 
...
* <b>--conf spark.driver.extraJavaOptions=-javaagent:/home/zhunan/code/
       ...
       `targetDirectory` is the directory in a shared storage system which is to store the files generated by
       KittenWhisker.
         
* <b>--conf "spark.executor.extraJavaOptions=-javaagent:
       ./happysparking-0.1-SNAPSHOT-jar-with-dependencies.jar=waitingLength=200000,
       targetDirectory=/flameperf/"</b>: similar to the last option, we specify java options for the executors
              
* <b>--conf "spark.executor.extraClassPath=./tools.jar": specifies tools.jar should be included in
